...
//
CLUSM::CLUSM() {
  mDefaultContextInitialized = false;
...
bool CLUSM::init() {
#if defined(_WIN32)
  if (::InitializeCriticalSectionAndSpinCount(&mCriticalSection, 0x400) ==
      FALSE) {
    return false;
  }
#elif defined(__linux__)
  if (pthread_mutex_init(&mCriticalSection, NULL)) {
    return false;
  }
#endif
...
void CLUSM::EnterCriticalSection() {
#if defined(_WIN32)
...
void CLUSM::LeaveCriticalSection() {
#if defined(_WIN32)
...
///////////////////////////////////////////////////////////////////////////////
//
void CLUSM::setInitialDefaultContext(cl_context context) {
  if (mDefaultContextInitialized == false) {
...
///////////////////////////////////////////////////////////////////////////////
//
void CLUSM::setDefaultContext(cl_context context) {
  if (mDefaultContext != context) {
    EnterCriticalSection();

    cl_context oldDefaultContext = mDefaultContext;

    mDefaultContext = context;

    clRetainContext(context);
    if (oldDefaultContext) {
      clReleaseContext(oldDefaultContext);
    }
...
///////////////////////////////////////////////////////////////////////////////
//
void *CLUSM::hostMemAlloc(cl_context context, cl_mem_alloc_flags_intel flags,
...
cl_int CLUSM::getMemAllocInfoINTEL(cl_context context, const void *ptr,
  ...
  if (mUSMContextInfo.AllocMap.size() == 0) {
